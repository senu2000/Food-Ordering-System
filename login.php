...
<body style="background-image: url(assets/img/login-cover.jpg); background-repeat: no-repeat; background-size: cover;">
    ...
    //show error message to user
        if (isset($_GET["message"])) {
            if ($_GET["message"] == 1) {
                echo "<div class='alert' style='background-color: white'><span class='closebtn' onclick='this.parentElement.style.display=`none`;'>&times;</span><strong>Registered successfully!</strong></div>";
