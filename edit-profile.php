            ...
            <div class="col-md-8 update-profile">
                <form action="process-profile.php" method="post" enctype="multipart/form-data">
                    ...
                    if ($_GET["message"] == 1) {
                        ...
                        echo "<div class='alert' style='background-color: white; color: #212529'><span class='closebtn' onclick='this.parentElement.style.display=`none`;'>&times;</span><strong>Image updated succssfully!</strong></div>";
                    } elseif ($_GET["message"] == 7) {
                        echo "<div class='alert' style='background-color: white; color: #212529'><span class='closebtn' onclick='this.parentElement.style.display=`none`;'>&times;</span><strong>Updated succssfully!</strong></div>";
