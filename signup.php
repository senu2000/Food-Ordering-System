...
<head>
    ...
    <title>Wellassa Eats | Signup</title>
...
<body style="background-image: url(assets/img/login-cover.jpg); background-repeat: no-repeat; background-size: cover;">
        ...
        <nav class="navbar navbar-expand-md bg-dark py-3 navbar-dark">
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="#"><img class="navbar-logo" src="assets/img/logo.png" style="width: 5rem;padding: 0.5rem;"></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-5"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navcol-5">
                    ...
                    </ul><a class="btn btn-primary ms-md-2" role="button" href="login.php" style="background: var(--bs-warning);">Login</a>
                </div>
            </div>
        </nav>
    </div>
    ...
    <?php
        ...
        if (isset($_GET["message"])) {
            if ($_GET["message"] == 1) {
                ...
                echo "<div class='error'><span class='closebtn' onclick='this.parentElement.style.display=`none`;'>&times;</span><strong>Please fill out all required feilds!</strong></div>";
            } elseif ($_GET["message"] == 4) {
                echo "<div class='error'><span class='closebtn' onclick='this.parentElement.style.display=`none`;'>&times;</span><strong>Invalid email address!</strong></div>";
                ...
                echo "<div class='error'><span class='closebtn' onclick='this.parentElement.style.display=`none`;'>&times;</span><strong>Registered failed!</strong></div>";
            }
        }
    ?>
    <!--form start-->        
    <div class="form-container">
        ...
        <form action="process-signup.php" method='POST' enctype="multipart/form-data">
            ...
            <input type="text" name="phone-no" placeholder="enter phone number" class="box"/>
